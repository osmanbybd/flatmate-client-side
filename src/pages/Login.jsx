          ...
          <div className="card-body">
            ...
            <form onSubmit={handleSignIn} className="fieldset">
              ...
              <input
                ...
                name="email"
                required
                className="input border border-gray-200 shadow-lg"
                placeholder="Email"
              />
              <div className="relative ">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-md shadow-lg border border-gray-200"
                />
                ...
                >
                  {showPassword ? (
                    <IoIosEye size={20} className="cursor-pointer" />
                  ) : (
                    <IoIosEyeOff size={20} className="cursor-pointer" />
                  )}
                </span>
              </div>
