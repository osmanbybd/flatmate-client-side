...
const Reurement = () => {
  ...
  return (
    <div className="p-8 " data-aos="fade-up" data-aos-duration="3000">
      <div className="text-center py-4  ">
        <h1 className="lg:text-6xl md:text-3xl text-2xl font-semibold">
          How It Works
        </h1>
        <p>
          Finding the perfect roommate is easy with our simple 4-step process.
        </p>
      </div>
